...
*Tim Noreliusson Lingestedt, 2026-09-22*
...
*__OBS!__* Efter att *Pay as you go* har aktiverats på *__Azure__* kontot fungerar inte längre VM storleken *Standard_B2ats_v2*. Det enklaste är att ändra detta i *main.bicepparam* filen, enligt beskrivning ovan. Till exempel storlek *Standard_D2als_v6* fungerar okej. Alla bilder i verifieringen är tagna innan *Pay as you go* aktiverades.
